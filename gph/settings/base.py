...
ALLOWED_HOSTS = ['https://puzzlehunt.up.railway.app']

CSRF_TRUSTED_ORIGINS = ['https://puzzlehunt.up.railway.app']
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "puzzles/static")
]
...
TIME_ZONE = 'America/Los_Angeles' #FIXME
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.normpath(os.path.join(BASE_DIR, 'puzzles/static'))
